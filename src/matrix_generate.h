...
void check_matrix_generate(const int a, const int b, const int l, std::vector<int> &the_matrix){
...
void check_matrix_generate_with_idxMatrix(const int a, const int b, const int l, std::vector<int> &the_matrix, std::vector<int> &matrix_of_index){
    std::random_device rd;
    std::mt19937 g(rd());
    std::vector<int> offsetvector(a * b);
    std::iota(offsetvector.begin(), offsetvector.end(), 0);
